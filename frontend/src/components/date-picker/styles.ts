...
export const datePickerStyles = tv({
  slots: {
    ...
    inputRow: 'relative',
    field:
      'flex h-11 w-full rounded-lg border border-border bg-surface py-2 pr-12 pl-3 text-sm transition-colors placeholder:text-placeholder focus:border-transparent focus:ring-2 focus:ring-primary focus:outline-none disabled:cursor-not-allowed disabled:opacity-50',
